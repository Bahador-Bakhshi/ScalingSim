...
def load_trace(trace_file_name, outname):
    ...
    lns1 = ax1.plot(rate, small_inst, label='L-INS-Prov', color='tab:orange', linestyle='--', marker="s", fillstyle='none', linewidth=1)
    lns2 = ax1.plot(rate, small_sla, label='L-INS-SLA', color='tab:orange', linestyle='-.', marker="o", fillstyle='none', linewidth=1)
    lns3 = ax1.plot(rate, small_total, label='L-INS-OPEX', color='tab:orange', linestyle='solid', marker="+", fillstyle='none', linewidth=1)
    
    lns1 = ax1.plot(rate, big_inst, label='H-INS-Prov', color='tab:blue', linestyle='--', marker="s", fillstyle='none', linewidth=1)
    lns2 = ax1.plot(rate, big_sla, label='H-INS-SLA', color='tab:blue', linestyle='-.', marker="o", fillstyle='none', linewidth=1)
    lns3 = ax1.plot(rate, big_total, label='H-INS-OPEX', color='tab:blue', linestyle='solid', marker="+", fillstyle='none', linewidth=1)
